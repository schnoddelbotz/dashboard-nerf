...
func main() {
	...
	flag.StringVar(&audioPlayer, "audioplayer", defaultAudioPlayer, "audio player to use for MP3/WAV")
	flag.StringVar(&videoPlayer, "videoplayer", defaultVideoPlayer, "video player to use for MP4/WEBM")
	flag.Parse()
